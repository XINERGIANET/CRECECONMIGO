...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/images/LOGO X - 3D - SIN FONDO.png') }}?v={{ filemtime(public_path('assets/images/LOGO X - 3D - SIN FONDO.png')) }}">
